...
const ServicesSectionListCard = ({ item, index }) => {
  ...
  return (
    <div>
      <div className="py-[30px] px-3 lg:px-5 rounded-md border border-x-[#ccf0f3] border-y-[#fff5df] ">
        ...
        <div className="flex items-center justify-between pt-12">
          ...
          <span
            className=" w-[44px] h-[44px] flex item-center justify-center text-[18px] leading-[30px] font-[600]"
            style={styles}
          >
            {index + 1}
          </span>
